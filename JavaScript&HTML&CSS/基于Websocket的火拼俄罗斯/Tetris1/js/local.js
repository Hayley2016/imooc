...
var Local = function(socket) {
    ...
    var move = function() {
        ...
        if (!game.down()) {
            ...
            if (gameOver) {
                game.gameover(false);
                document.getElementById('remote_resultDiv').innerHTML = '你赢了';
                socket.emit('lose');
                stop();
            } else {
    ...
    var start = function() {
        var doms = {
            ...
            resultDiv: document.getElementById('local_resultDiv')
        };
        game = new Game();
    ...
    socket.on('leave', function() {
        document.getElementById('local_resultDiv').innerHTML = '对方掉线';
        document.getElementById('remote_resultDiv').innerHTML = '已掉线';
        stop();
    });
